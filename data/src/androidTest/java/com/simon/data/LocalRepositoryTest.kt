...
class LocalRepositoryTest {
    ...
    @Test
    fun testGetCharacters_whenDatabaseIsNotEmpty_shouldReturnSuccessWithCharacters() =
        runTest{
            // Insert a CharactersResponseItem into the database
            val data  = Json.decodeFromString<List<CharactersResponseItem>>(dummyData)
            dao.insertAll(data)
    ...
    @Test
    fun testSaveCharacters_shouldDeleteCharactersFromDatabase() = runTest {
        // Create a list of CharactersResponseItems
        val data  = Json.decodeFromString<List<CharactersResponseItem>>(dummyData)
        //insert
        dao.insertAll(data)
